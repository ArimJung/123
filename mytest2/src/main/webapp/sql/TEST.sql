...
CREATE TABLE REPLY1(
	...
	CONSTRAINT BOARD1_REPLY1 FOREIGN KEY (BID) REFERENCES BOARD1 (BID) ON DELETE CASCADE
);
...
CREATE TABLE FAV(
	...
	BID INT,
	FAV INT DEFAULT 1,
	CONSTRAINT BOARD1_FAV FOREIGN KEY (BID) REFERENCES BOARD1 (BID) ON DELETE CASCADE
);
